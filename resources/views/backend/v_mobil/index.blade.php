...
<style>
    ...
    /* Tombol Tambah (mengikuti tema gradient dashboard) */
    .btn-tambah {
...
<div class="custom-card mt-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('backend.mobil.create') }}">
            <button type="button" class="btn-tambah">+ Tambah Mobil</button>
        </a>

        <form action="{{ route('backend.mobil.index') }}" method="GET">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="display:flex; gap:6px;">
                    ...
                    <a href="{{ route('backend.mobil.edit', $row->id) }}">
